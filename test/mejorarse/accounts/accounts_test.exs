defmodule Mejorarse.AccountsTest do
  ...
  describe "credentials" do
    ...
    @valid_attrs %{email: "some email", password_hash: "some password_hash", pw_last_try: "some pw_last_try", pw_tries: 42}
    @update_attrs %{email: "some updated email", password_hash: "some updated password_hash", pw_last_try: "some updated pw_last_try", pw_tries: 43}
    @invalid_attrs %{email: nil, password_hash: nil, pw_last_try: nil, pw_tries: nil}
    ...
    test "create_credential/1 with valid data creates a credential" do
      ...
      assert credential.pw_last_try == "some pw_last_try"
      assert credential.pw_tries == 42
    end
    ...
    test "update_credential/2 with valid data updates the credential" do
      ...
      assert credential.pw_last_try == "some updated pw_last_try"
      assert credential.pw_tries == 43
    end
